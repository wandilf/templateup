...
<header class="page-header<?php if( $has_image ) echo ' has-featured-image'; ?>">
	<?php if( $has_image ): ?><div class="page-header-background" style="background-image: url('<?php echo wp_get_attachment_image_url( get_post_thumbnail_id( $shop_page_id ), 'listable-featured-image' ); ?>');"></div><?php endif; ?>
